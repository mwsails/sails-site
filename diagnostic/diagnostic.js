...
(function () {
  ...
  function renderSuccess() {
    ...
    success.innerHTML = `
      ...
      <h2 class="diag-success__h">Got it. I'll review this personally.</h2>
      <p class="diag-success__msg">You'll hear back from me within one business day, whether it's a fit or not.</p>

      <div class="diag-success__actions">
        <a href="mailto:matt@sailsadvisory.com" class="btn btn--primary btn--lg">Email Matt Directly <span aria-hidden="true">→</span></a>
      </div>

      <div class="diag-success__divider"></div>

      <p class="diag-success__sub"><strong>Want to go deeper before I follow up?</strong></p>
      <p class="diag-success__sub">Download the full diagnostic questionnaire and fill it out in the meantime. It's 20 to 30 minutes of work, and it means we skip the basics when I reach out.</p>
